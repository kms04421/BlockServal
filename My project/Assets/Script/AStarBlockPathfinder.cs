...
public class AStarBlockPathfinder
{
    ...
    public List<Vector3Int> FindPath(Vector3Int start, Vector3Int goal, BlockType[,,] blocks)
    {
    ...
    private List<Vector3Int> ReconstructPath(Node endPos)
    {
    ...
    private int Heuristic(Vector3Int a, Vector3Int b) // a = start ,b = goal
    {
